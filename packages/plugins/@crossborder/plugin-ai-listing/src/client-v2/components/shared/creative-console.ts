...
/* ── 缩放细查(A5):滚轮放大 100–400%,放大后拖动平移、双击复位 ── */
.aic-scope .stagezoom{position:relative}
.aic-scope .stagezoom.zooming .stage{cursor:grab}
.aic-scope .stagezoom.zooming .stage:active{cursor:grabbing}
